...
def post(endpoint, params, json, response_format):
    ...
    response = session.post(
        urljoin(server, endpoint), headers=headers, params=params, json=json
    )
    if response.ok:
...
def assembly_info(
    species: str, bands=None, callback=None, synonyms=None, response_format="json"
):
    return get(
...
def biotypes_groups(
    callback=None, group=None, object_type=None, response_format="json"
):
    return get(
...
def compara_species_sets(
    method: str, callback=None, compara=None, response_format="json"
):
    return get(
...
def data(callback=None, response_format="json"):
    return get(
        f"info/data", params=dict(callback=callback), response_format=response_format
    )


def external_dbs(
    species: str, callback=None, feature=None, filter=None, response_format="json"
):
    return get(
...
def ping(callback=None, response_format="json"):
    return get(
        f"info/ping", params=dict(callback=callback), response_format=response_format
    )


def rest(callback=None, response_format="json"):
    return get(
        f"info/rest", params=dict(callback=callback), response_format=response_format
    )
...
def variation_population_name(
    population_name: str, species: str, callback=None, response_format="json"
):
    return get(
...
def variation_populations(
    species: str, callback=None, filter=None, response_format="json"
):
    return get(
...
def symbol_lookup(
    ...
    return get(
        ...
        params=dict(callback=callback, expand=expand, format=format),
        response_format=response_format,
    )
...
def assembly_translation(
    id: str, region: str, callback=None, species=None, response_format="json"
):
    return get(
...
def ontology_ancestors_chart(
    id: str, callback=None, ontology=None, response_format="json"
):
    return get(
...
def ontology_id(
    id: str, callback=None, relation=None, simple=None, response_format="json"
):
    return get(
        f"ontology/id/{id}",
...
def array(
    microarray: str, species: str, vendor: str, callback=None, response_format="json"
):
    return get(
...
def get_binding_matrix(
    binding_matrix: str, species: str, callback=None, unit=None, response_format="json"
):
    return get(
...
def regulatory_id(
    id: str, species: str, activity=None, callback=None, response_format="json"
):
    return get(
...
def variation_pmcid_get(
    pmcid: str, species: str, callback=None, response_format="json"
):
    return get(
...
class Ensembl:
    ...
    def compara_methods(
        self, callback=None, compara=None, response_format="json", **kwargs
    ):
        return self.get(
            f"info/compara/methods",
            params=dict(callback=callback, compara=compara, **kwargs),
    ...
    def compara_species_sets(
        self, method: str, callback=None, compara=None, response_format="json"
    ):
        return self.get(
            f"info/compara/species_sets/{method}",
            params=dict(callback=callback, compara=compara),
    ...
    def variation_population_name(self,
                                  population_name: str, species: str, callback=None, response_format="json"
                                  ):
        return self.get(
            f"info/variation/populations/{species}/{population_name}",
    ...
    def variation_populations(self,
                              species: str, callback=None, filter=None, response_format="json"
                              ):
        return self.get(
            f"info/variation/populations/{species}",
    ...
    def ontology_ancestors_chart(self,
                                 id: str, callback=None, ontology=None, response_format="json"
                                 ):
        return self.get(
            f"ontology/ancestors/chart/{id}",
...
if __name__ == "__main__":
    ...
    # print(vep_region("9:22125503-22125502:1", "C", "human"))
    # print(vep_region(["21 26960070 rs116645811 G A . . .", "21 26965148 rs1135638 G A . . ."], "human",))
    ...
    # print(ensembl.ensembl.ontology_id("GO:0005667"))
