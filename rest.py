...
def _cafe_genetree_id(id: str, compara=None, nh_format=None, format='json'):
    ...
    response = requests.get(f"https://rest.ensembl.org/cafe/genetree/id/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(compara=compara, nh_format=nh_format, format=format))
    return response.json()
...
def _(symbol: list, species='human', expand=None, format=None):
    response = requests.post(
        f"https://rest.ensembl.org/lookup/symbol/{species}", headers={"Content-Type": "application/json"}, json={"symbol": symbol},
        params=dict(expand=expand, format=format))
    return response.json()
...
def _ga4gh_callsets(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org/ga4gh/callsets/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()


def _ga4gh_datasets_search(pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/datasets/search", headers={
                             "Content-Type": "application/json"}, json=dict(pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()


def _ga4gh_callsets_search(variantSetId=None, name=None, pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/callsets/search", headers={"Content-Type": "application/json"}, json=dict(
        variantSetId=variantSetId, name=name, pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()


def _ga4gh_datasets(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org/ga4gh/datasets/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()


def _ga4gh_featuresets_search(datasetId=None, pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/featuresets/search", headers={"Content-Type": "application/json"}, json=dict(
        datasetId=datasetId, pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()


def _ga4gh_featuresets(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org//ga4gh/featuresets/Ensembl/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()


def _ga4gh_variants(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org/ga4gh/variants/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()
...
def _ga4gh_variants_search(variantSetId=None, referenceName=None, start=None, end=None, callSetIds=None, pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/variants/search", headers={"Content-Type": "application/json"}, json=dict(
        variantSetId=variantSetId, referenceName=referenceName, start=start, end=end, callSetIds=callSetIds, pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()
...
def _ga4gh_variantannotations_search(variantAnnotationSetId=None, effects=None, end=None, pageSize=None, pageToken=None, referenceId=None, referenceName=None, start=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/variantannotations/search", headers={"Content-Type": "application/json"}, json=dict(
        variantAnnotationSetId=variantAnnotationSetId, effects=effects, end=end, pageSize=pageSize, pageToken=pageToken, referenceId=referenceId, referenceName=referenceName, start=start), params=dict(format=format))
    return response.json()


def _ga4gh_variantsets_search(datasetId=None, pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/variantsets/search", headers={"Content-Type": "application/json"}, json=dict(
        datasetId=datasetId, pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()


def _ga4gh_variantsets(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org/ga4gh/variantsets/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()
...
def _ga4gh_references_search(referenceSetId=None, accession=None, md5checksum=None, pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/references/search", headers={"Content-Type": "application/json"}, json=dict(
        referenceSetId=referenceSetId, accession=accession, md5checksum=md5checksum, pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()


def _ga4gh_references(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org/ga4gh/references/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()


def _ga4gh_referencesets_search(accession=None, pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/referencesets/search", headers={"Content-Type": "application/json"}, json=dict(
        accession=accession, pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()


def _ga4gh_referencesets(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org/ga4gh/referencesets/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()


def _ga4gh_variantannotationsets_search(variantSetId=None, pageSize=None, pageToken=None, format='json'):
    response = requests.post(f"https://rest.ensembl.org/ga4gh/variantannotationsets/search", headers={"Content-Type": "application/json"}, json=dict(
        variantSetId=variantSetId, pageSize=pageSize, pageToken=pageToken), params=dict(format=format))
    return response.json()


def _ga4gh_variantannotationsets(id: str, format='json'):
    response = requests.get(f"https://rest.ensembl.org/ga4gh/variantannotationsets/{id}", headers={
                            "Content-Type": "application/json"}, params=dict(format=format))
    return response.json()
...
variation_pmcid = subparsers.add_parser(
    'variation_pmcid', help='variation_pmcid')
...
cafe_genetree_member_symbol = subparsers.add_parser(
    'cafe_genetree_member_symbol', help='cafe_genetree_member_symbol help')
...
genetree_member_id = subparsers.add_parser(
    'genetree_member_id', help='genetree_member_id help')
...
genetree_member_symbol = subparsers.add_parser(
    'genetree_member_symbol', help='genetree_member_symbol help')
...
alignment_region = subparsers.add_parser(
    'alignment_region', help='alignment_region help')
...
homology_symbol = subparsers.add_parser(
    'homology_symbol', help='homology_symbol help')
...
info_analysis = subparsers.add_parser(
    'info_analysis', help='info_analysis help')
info_analysis.add_argument('--format', default='json')
info_analysis.add_argument('--species', default='homo_sapiens')

info_assembly = subparsers.add_parser(
    'info_assembly', help='info_assembly help')
...
info_assembly_region_name = subparsers.add_parser(
    'info_assembly_region_name', help='info_assembly_region_name help')
...
info_biotypes = subparsers.add_parser(
    'info_biotypes', help='info_biotypes help')
info_biotypes.add_argument('--format', default='json')
info_biotypes.add_argument('--species', default='homo_sapiens')

info_biotypes_group = subparsers.add_parser(
    'info_biotypes_group', help='info_biotypes_group help')
...
info_biotypes_name = subparsers.add_parser(
    'info_biotypes_name', help='info_biotypes_name help')
...
info_compara_methods = subparsers.add_parser(
    'info_compara_methods', help='info_compara_methods help')
...
info_compara_species_sets = subparsers.add_parser(
    'info_compara_species_sets', help='info_compara_species_sets help')
...
info_comparas = subparsers.add_parser(
    'info_comparas', help='info_comparas help')
...
info_eg_version = subparsers.add_parser(
    'info_eg_version', help='info_eg_version help')
info_eg_version.add_argument('--format', default='json')

info_external_dbs = subparsers.add_parser(
    'info_external_dbs', help='info_external_dbs help')
...
info_divisions = subparsers.add_parser(
    'info_divisions', help='info_divisions help')
...
info_genomes_accession = subparsers.add_parser(
    'info_genomes_accession', help='info_genomes_accession help')
...
info_genomes_assembly = subparsers.add_parser(
    'info_genomes_assembly', help='info_genomes_assembly help')
...
info_genomes_division = subparsers.add_parser(
    'info_genomes_division', help='info_genomes_division help')
...
info_genomes_taxonomy = subparsers.add_parser(
    'info_genomes_taxonomy', help='info_genomes_taxonomy help')
...
info_software = subparsers.add_parser(
    'info_software', help='info_software help')
...
info_variation = subparsers.add_parser(
    'info_variation', help='info_variation help')
...
info_variation_consequence_types = subparsers.add_parser(
    'info_variation_consequence_types', help='info_variation_consequence_types help')
...
info_variation_populations = subparsers.add_parser(
    'info_variation_populations', help='info_variation_populations help')
...
info_variation_species = subparsers.add_parser(
    'info_variation_species', help='info_variation_species help')
...
lookup_symbol = subparsers.add_parser(
    'lookup_symbol', help='lookup_symbol help')
...
map_translation = subparsers.add_parser(
    'map_translation', help='map_translation help')
...
ontology_ancestors = subparsers.add_parser(
    'ontology_ancestors', help='ontology_ancestors help')
...
ontology_ancestors_chart = subparsers.add_parser(
    'ontology_ancestors_chart', help='ontology_ancestors_chart help')
...
ontology_descendants = subparsers.add_parser(
    'ontology_descendants', help='ontology_descendants help')
...
ontology_name = subparsers.add_parser(
    'ontology_name', help='ontology_name help')
...
taxonomy_classification = subparsers.add_parser(
    'taxonomy_classification', help='taxonomy_classification help')
...
taxonomy_name = subparsers.add_parser(
    'taxonomy_name', help='taxonomy_name help')
...
overlap_region = subparsers.add_parser(
    'overlap_region', help='overlap_region help')
...
overlap_translation = subparsers.add_parser(
    'overlap_translation', help='overlap_translation help')
...
phenotype_accession = subparsers.add_parser(
    'phenotype_accession', help='phenotype_accession help')
...
phenotype_gene = subparsers.add_parser(
    'phenotype_gene', help='phenotype_gene help')
...
phenotype_region = subparsers.add_parser(
    'phenotype_region', help='phenotype_region help')
...
phenotype_term = subparsers.add_parser(
    'phenotype_term', help='phenotype_term help')
...
regulatory_microarray_vendor = subparsers.add_parser(
    'regulatory_microarray_vendor', help='regulatory_microarray_vendor help')
...
regulatory_species = subparsers.add_parser(
    'regulatory_species', help='regulatory_species help')
regulatory_species.add_argument('--format', default='json')
regulatory_species.add_argument('--species', default='homo_sapiens')

species_binding_matrix = subparsers.add_parser(
    'species_binding_matrix', help='species_binding_matrix help')
...
regulatory_microarray = subparsers.add_parser(
    'regulatory_microarray', help='regulatory_microarray help')
regulatory_microarray.add_argument('--format', default='json')
regulatory_microarray.add_argument('--species', default='homo_sapiens')

regulatory_probe = subparsers.add_parser(
    'regulatory_probe', help='regulatory_probe help')
...
regulatory_probe_set = subparsers.add_parser(
    'regulatory_probe_set', help='regulatory_probe_set help')
...
regulatory_id = subparsers.add_parser(
    'regulatory_id', help='regulatory_id help')
...
sequence_region = subparsers.add_parser(
    'sequence_region', help='sequence_region help')
...
transcript_haplotypes = subparsers.add_parser(
    'transcript_haplotypes', help='transcript_haplotypes help')
...
vep_region_get = subparsers.add_parser(
    'vep_region_get', help='vep_region_get help')
...
vep_region_post = subparsers.add_parser(
    'vep_region_post', help='vep_region_post help')
...
ga4gh_features = subparsers.add_parser(
    'ga4gh_features', help='ga4gh_features help')
ga4gh_features.add_argument('id')
ga4gh_features.add_argument('--format', default='json')

ga4gh_beacon_query = subparsers.add_parser(
    'ga4gh_beacon_query', help='ga4gh_beacon_query help')
...
ga4gh_callsets = subparsers.add_parser(
    'ga4gh_callsets', help='ga4gh_callsets help')
ga4gh_callsets.add_argument('id')
ga4gh_callsets.add_argument('--format', default='json')

ga4gh_datasets_search = subparsers.add_parser(
    'ga4gh_datasets_search', help='ga4gh_datasets_search help')
...
ga4gh_callsets_search = subparsers.add_parser(
    'ga4gh_callsets_search', help='ga4gh_callsets_search help')
...
ga4gh_datasets = subparsers.add_parser(
    'ga4gh_datasets', help='ga4gh_datasets help')
ga4gh_datasets.add_argument('id')
ga4gh_datasets.add_argument('--format', default='json')

ga4gh_featuresets_search = subparsers.add_parser(
    'ga4gh_featuresets_search', help='ga4gh_featuresets_search help')
...
ga4gh_featuresets = subparsers.add_parser(
    'ga4gh_featuresets', help='ga4gh_featuresets help')
ga4gh_featuresets.add_argument('id')
ga4gh_featuresets.add_argument('--format', default='json')

ga4gh_variants = subparsers.add_parser(
    'ga4gh_variants', help='ga4gh_variants help')
ga4gh_variants.add_argument('id')
ga4gh_variants.add_argument('--format', default='json')

ga4gh_variants_search = subparsers.add_parser(
    'ga4gh_variants_search', help='ga4gh_variants_search help')
...
ga4gh_variantannotations_search = subparsers.add_parser(
    'ga4gh_variantannotations_search', help='ga4gh_variantannotations_search help')
ga4gh_variantannotations_search.add_argument('--format', default='json')
ga4gh_variantannotations_search.add_argument(
    '--variantAnnotationSetId', default=None)
...
ga4gh_variantsets_search = subparsers.add_parser(
    'ga4gh_variantsets_search', help='ga4gh_variantsets_search help')
...
ga4gh_variantsets = subparsers.add_parser(
    'ga4gh_variantsets', help='ga4gh_variantsets help')
ga4gh_variantsets.add_argument('id')
ga4gh_variantsets.add_argument('--format', default='json')

ga4gh_references_search = subparsers.add_parser(
    'ga4gh_references_search', help='ga4gh_references_search help')
...
ga4gh_references = subparsers.add_parser(
    'ga4gh_references', help='ga4gh_references help')
ga4gh_references.add_argument('id')
ga4gh_references.add_argument('--format', default='json')

ga4gh_referencesets_search = subparsers.add_parser(
    'ga4gh_referencesets_search', help='ga4gh_referencesets_search help')
...
ga4gh_referencesets = subparsers.add_parser(
    'ga4gh_referencesets', help='ga4gh_referencesets help')
ga4gh_referencesets.add_argument('id')
ga4gh_referencesets.add_argument('--format', default='json')

ga4gh_variantannotationsets_search = subparsers.add_parser(
    'ga4gh_variantannotationsets_search', help='ga4gh_variantannotationsets_search help')
...
ga4gh_variantannotationsets = subparsers.add_parser(
    'ga4gh_variantannotationsets', help='ga4gh_variantannotationsets help')
ga4gh_variantannotationsets.add_argument('id')
ga4gh_variantannotationsets.add_argument('--format', default='json')

ga4gh_features_search = subparsers.add_parser(
    'ga4gh_features_search', help='ga4gh_features_search help')
...
if args.command == "variant_recoder":
    ...
    pprint.pprint(_cafe_genetree_id(args.id, compara=args.compara,
                  nh_format=args.nh_format, format=args.format))
    ...
    pprint.pprint(_xrefs_symbol(args.symbol, db_type=args.db_type,
                  external_db=args.external_db, object_type=args.object_type, format=args.format))
elif args.command == "xrefs_id":
    pprint.pprint(_xrefs_id(args.id, all_levels=args.all_levels, db_type=args.db_type,
                  external_db=args.external_db, object_type=args.object_type, species=args.species, format=args.format))
elif args.command == "xrefs_name":
    pprint.pprint(_xrefs_name(args.name, db_type=args.db_type,
                  external_db=args.external_db, format=args.format))
    ...
    pprint.pprint(_info_assembly(species=args.species,
                  format=args.format, bands=args.bands, synonyms=args.synonyms))
elif args.command == "info_assembly_region_name":
    pprint.pprint(_info_assembly_region_name(args.region_name, species=args.species,
                  format=args.format, bands=args.bands, synonyms=args.synonyms))
    ...
    pprint.pprint(_info_biotypes_group(group=args.group,
                  object_type=args.object_type, format=args.format))
elif args.command == "info_biotypes_name":
    pprint.pprint(_info_biotypes_name(name=args.name,
                  object_type=args.object_type, format=args.format))
elif args.command == "info_compara_methods":
    pprint.pprint(_info_compara_methods(
        cla=args.cla, compara=args.compara, format=args.format))
elif args.command == "info_compara_species_sets":
    pprint.pprint(_info_compara_species_sets(
        args.method, compara=args.compara, format=args.format))
    ...
    pprint.pprint(_info_external_dbs(feature=args.feature,
                  filter=args.filter, format=args.format))
elif args.command == "info_divisions":
    pprint.pprint(_info_divisions(format=args.format))
elif args.command == "info_genomes":
    pprint.pprint(_info_genomes(
        args.name, expand=args.expand, format=args.format))
elif args.command == "info_genomes_accession":
    pprint.pprint(_info_genomes_accession(args.accession,
                  expand=args.expand, format=args.format))
elif args.command == "info_genomes_assembly":
    pprint.pprint(_info_genomes_assembly(args.assembly_id,
                  expand=args.expand, format=args.format))
elif args.command == "info_genomes_division":
    pprint.pprint(_info_genomes_division(
        args.division, expand=args.expand, format=args.format))
    ...
    pprint.pprint(_info_species(division=args.division, hide_strain_info=args.hide_strain_info,
                  strain_collection=args.strain_collection, format=args.format))
elif args.command == "info_variation":
    pprint.pprint(_info_variation(species=args.species,
                  filter=args.filter, format=args.format))
elif args.command == "info_variation_consequence_types":
    pprint.pprint(_info_variation_consequence_types(
        rank=args.rank, format=args.format))
elif args.command == "info_variation_populations":
    pprint.pprint(_info_variation_populations(
        args.population_name, species=args.species, format=args.format))
elif args.command == "info_variation_species":
    pprint.pprint(_info_variation_species(species=args.species,
                  filter=args.filter, format=args.format))
elif args.command == "ld":
    pprint.pprint(_ld(args.id, args.population_name, species=args.species, attribs=args.attribs,
                  callback=args.callback, d_prime=args.d_prime, r2=args.r2, window_size=args.window_size, format=args.format))
elif args.command == "ld_pairwise":
    pprint.pprint(_ld_pairwise(args.id1, args.id2, species=args.species, d_prime=args.d_prime,
                  population_name=args.population_name, r2=args.r2, format=args.format))
elif args.command == "ld_region":
    pprint.pprint(_ld_region(args.population_name, args.region,
                  species=args.species, d_prime=args.d_prime, r2=args.r2, format=args.format))
    ...
    pprint.pprint(_lookup_symbol(args.symbol, species=args.species,
                  expand=args.expand, format=args.format))
elif args.command == "map_cdna":
    pprint.pprint(_map_cdna(args.id, args.region, include_original_region=args.include_original_region,
                  species=args.species, format=args.format))
elif args.command == "map_cds":
    pprint.pprint(_map_cds(args.id, args.region, include_original_region=args.include_original_region,
                  species=args.species, format=args.format))
elif args.command == "map_assembly":
    pprint.pprint(_map_assembly(args.asm_one, args.asm_two, args.region, species=args.species,
                  coord_system=args.coord_system, target_coord_system=args.target_coord_system, format=args.format))
elif args.command == "map_translation":
    pprint.pprint(_map_translation(args.id, args.region,
                  species=args.species, format=args.format))
elif args.command == "ontology_ancestors":
    pprint.pprint(_ontology_ancestors(
        args.id, ontology=args.ontology, format=args.format))
elif args.command == "ontology_ancestors_chart":
    pprint.pprint(_ontology_ancestors_chart(
        args.id, ontology=args.ontology, format=args.format))
elif args.command == "ontology_descendants":
    pprint.pprint(_ontology_descendants(args.id, closest_term=args.closest_term, ontology=args.ontology,
                  subset=args.subset, zero_distance=args.zero_distance, format=args.format))
elif args.command == "ontology_id":
    pprint.pprint(_ontology_id(args.id, relation=args.relation,
                  simple=args.simple, format=args.format))
elif args.command == "ontology_name":
    pprint.pprint(_ontology_name(args.name, ontology=args.ontology,
                  relation=args.relation, simple=args.simple, format=args.format))
    ...
    pprint.pprint(_taxonomy_id(
        args.id, simple=args.simple, format=args.format))
    ...
    pprint.pprint(_overlap_translation(args.id, db_type=args.db_type, feature=args.feature,
                  so_term=args.so_term, species=args.species, type=args.type, format=args.format))
elif args.command == "phenotype_accession":
    pprint.pprint(_phenotype_accession(args.accession, include_children=args.include_children, include_pubmed_id=args.include_pubmed_id,
                  include_review_status=args.include_review_status, source=args.source, format=args.format))
    ...
    pprint.pprint(_phenotype_region(args.region, species=args.species, feature_type=args.feature_type, include_pubmed_id=args.include_pubmed_id, include_review_status=args.include_review_status,
                  include_submitter=args.include_submitter, non_specified=args.non_specified, only_phenotypes=args.only_phenotypes, trait=args.trait, tumour=args.tumour, format=args.format))
elif args.command == "phenotype_term":
    pprint.pprint(_phenotype_term(args.term, species=args.species, include_children=args.include_children,
                  include_pubmed_id=args.include_pubmed_id, include_review_status=args.include_review_status, source=args.source, format=args.format))
elif args.command == "regulatory_microarray_vendor":
    pprint.pprint(_regulatory_microarray_vendor(args.microarray,
                  args.vendor, species=args.species, format=args.format))
elif args.command == "regulatory_species":
    pprint.pprint(_regulatory_species(
        species=args.species, format=args.format))
elif args.command == "species_binding_matrix":
    pprint.pprint(_species_binding_matrix(args.binding_matrix,
                  species=args.species, unit=args.unit, format=args.format))
    ...
    pprint.pprint(_regulatory_probe(args.microarray, args.probe, species=args.species,
                  gene=args.gene, transcripts=args.transcripts, format=args.format))
elif args.command == "regulatory_probe_set":
    pprint.pprint(_regulatory_probe_set(args.microarray, args.probe_set, species=args.species,
                  gene=args.gene, transcripts=args.transcripts, format=args.format))
elif args.command == "regulatory_id":
    pprint.pprint(_regulatory_id(args.id, species=args.species,
                  activity=args.activity, format=args.format))
    ...
    pprint.pprint(_sequence_id(args.id, db_type=args.db_type, end=args.end, expand_3prime=args.expand_3prime, expand_5prime=args.expand_5prime, mask=args.mask,
                  mask_feature=args.mask_feature, multiple_sequences=args.multiple_sequences, object_type=args.object_type, species=args.species, start=args.start, type=args.type, format=args.format))
elif args.command == "sequence_region":
    pprint.pprint(_sequence_region(args.region, species=args.species, coord_system=args.coord_system, coord_system_version=args.coord_system_version,
                  expand_3prime=args.expand_3prime, expand_5prime=args.expand_5prime, mask=args.mask, mask_feature=args.mask_feature, format=args.format))
elif args.command == "transcript_haplotypes":
    pprint.pprint(_transcript_haplotypes(args.id, species=args.species, aligned_sequences=args.aligned_sequences,
                  samples=args.samples, sequence=args.sequence, format=args.format))
elif args.command == "_vep_hgvs":
    pprint.pprint(
        _vep_hgvs(args.hgvs, species=args.species, format=args.format))
    ...
    pprint.pprint(_ga4gh_features_search(end=args.end, referenceName=args.referenceName, start=args.start, featureTypes=args.featureTypes,
                  featureSetId=args.featureSetId, pageSize=args.pageSize, pageToken=args.pageToken, parentId=args.parentId, format=args.format))
    ...
    pprint.pprint(_ga4gh_datasets_search(pageSize=args.pageSize,
                  pageToken=args.pageToken, format=args.format))
elif args.command == "ga4gh_callsets_search":
    pprint.pprint(_ga4gh_callsets_search(variantSetId=args.variantSetId, name=args.name,
                  pageSize=args.pageSize, pageToken=args.pageToken, format=args.format))
    ...
    pprint.pprint(_ga4gh_featuresets_search(datasetId=args.datasetId,
                  pageSize=args.pageSize, pageToken=args.pageToken, format=args.format))
    ...
    pprint.pprint(_ga4gh_variants_search(variantSetId=args.variantSetId, referenceName=args.referenceName, start=args.start,
                  end=args.end, callSetIds=args.callSetIds, pageSize=args.pageSize, pageToken=args.pageToken, format=args.format))
elif args.command == "ga4gh_variantannotations_search":
    pprint.pprint(_ga4gh_variantannotations_search(variantAnnotationSetId=args.variantAnnotationSetId, effects=args.effects, end=args.end,
                  pageSize=args.pageSize, pageToken=args.pageToken, referenceId=args.referenceId, referenceName=args.referenceName, start=args.start, format=args.format))
elif args.command == "ga4gh_variantsets_search":
    pprint.pprint(_ga4gh_variantsets_search(datasetId=args.datasetId,
                  pageSize=args.pageSize, pageToken=args.pageToken, format=args.format))
    ...
    pprint.pprint(_ga4gh_references_search(referenceSetId=args.referenceSetId, accession=args.accession,
                  md5checksum=args.md5checksum, pageSize=args.pageSize, pageToken=args.pageToken, format=args.format))
    ...
    pprint.pprint(_ga4gh_referencesets_search(accession=args.accession,
                  pageSize=args.pageSize, pageToken=args.pageToken, format=args.format))
    ...
    pprint.pprint(_ga4gh_variantannotationsets_search(variantSetId=args.variantSetId,
                  pageSize=args.pageSize, pageToken=args.pageToken, format=args.format))
    ...
    pprint.pprint(_info_genomes_taxonomy(args.taxon_name,
                  expand=args.expand, format=args.format))
